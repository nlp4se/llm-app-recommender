...
def run_command(k, search, output_dir, n=1, model="gpt-4o-search-preview", sleep=10):
    ...
    cmd = [
        ...
        "--model", model,
        "--sleep", str(sleep),
        "--criteria-folder", f"data/output/features/rq1/openai/k{str(k)}_{search.replace(' ', '_')}"
    ]
...
def main():
    ...
    base_output_dir = "./data/output/features/rq2/openai"
