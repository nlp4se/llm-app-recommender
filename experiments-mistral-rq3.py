...
def run_command(k, search, output_dir, n=4, model="mistral-large-2411", sleep=10):
    """Run the search command with given parameters."""
    cmd = [
        "python", "-m", "code.llm.mistral.search_mistral_rq3",
        "--output", output_dir,
        "--k", str(k),
        "--search", search,
        "--n", str(n),
...
def main():
    ...
    base_output_dir = "./data/output/features/rq3/mistral"
