...
def main(output_folder: str, k: int, input_csv: str, search: str, n: int = 1, model: str = "mistral-large-latest", sleep_time: int = 10):
    searchMistral = MistralSearch(model)
    searchMistral.run_prompt(output_folder, k, input_csv, search, n, sleep_time)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run prompts with Mistral Chat Completions API based on a CSV input.')
