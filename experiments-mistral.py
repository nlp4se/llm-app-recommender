...
def run_command(k, category, output_dir, n=5, model="mistral-large-2411", sleep=10):
    """Run the search command with given parameters."""
    cmd = [
        "python", "-m", "code.llm.mistral.search_mistral_uc1",
        "--output", output_dir,
        "--k", str(k),
        "--category", category,
        "--n", str(n),
...
def main():
    ...
    base_output_dir = "./data/output/search/uc1/mistral"
